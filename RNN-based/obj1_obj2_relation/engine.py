    ...
    def train(self, model, train_loader):
        ...
        for epoch in range(self.args.epochs):
            ...
            for num_batches, (input, target) in enumerate(train_loader):
                ...
                (obj1_pred, obj2_pred, rel_pred), _ = model(images, (obj_target1, obj_target2, rel_target), True)
            ...
            for num_batches, (input, target) in enumerate(data_loader):
                ...
                if isbeam:
                    ...
                    for i in range(len(beam_result)):
                        ...
                        paths.append(np.array(beam_result[i][1])[[0,2,1]])
                        paths_p.append(np.array(beam_result[i][2])[[0,2,1]])
